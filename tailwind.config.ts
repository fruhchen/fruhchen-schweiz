  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'glow-brand': '0 0 24px -4px rgba(249, 115, 22, 0.25)',
      ...
      backgroundImage: {
        'gradient-warm': 'linear-gradient(135deg, #FFF7ED 0%, #FEF9F3 50%, #F5F3FF 100%)',
        'gradient-brand': 'linear-gradient(135deg, #F97316 0%, #FB923C 50%, #FDBA74 100%)',
        'gradient-hero': 'linear-gradient(160deg, #FFF7ED 0%, #FFFBF5 30%, #F5F3FF 70%, #F0FDFA 100%)',
        'gradient-card': 'linear-gradient(145deg, rgba(255,255,255,0.9) 0%, rgba(255,247,237,0.5) 100%)',
      },
    },
  },
  plugins: [],
